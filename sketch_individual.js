...
let circleScaleFactor = 1;  // Initialize the scale factor for circles
const MAX_SCALE = 3;  // Maximum scaling factor for circles
const MIN_SCALE = 0.5; // Minimum scaling factor for circles
